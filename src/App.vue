      ...
      <div class="mobile-header__panel">
        <div class="container">
          <div class="mobile-header__body">
            ...
            <div
              class="
                search search--location--mobile-header
            ...
            >
              <div class="search__body">
                ...
                <div
                  class="
                    search__suggestions
                    suggestions suggestions--location--mobile-header
                  "
                ></div>
              </div>
            </div>
                      ...
                      <li class="menu__item">
                        ...
                        <a class="menu__item-link" href="">
                          <div class="menu__item-icon">
                            <img
                              srcset="
                                images/languages/language-1.png    1x,
                      ...
                      <li class="menu__item">
                        ...
                        <a class="menu__item-link" href="">
                          <div class="menu__item-icon">
                            <img
                              srcset="
                                images/languages/language-5.png    1x,
                            ...
                            <div class="col-6">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <ul
                                    class="
                                      megamenu__links megamenu__links--level--1
                                    "
                                  >
                    ...
                    <div class="search search--location--indicator">
                      <div class="search__body">
                        ...
                        <div
                          class="
                            search__suggestions
                            suggestions suggestions--location--indicator
                          "
                        ></div>
                      </div>
                    </div>
          ...
          <li class="mobile-links__item" data-collapse-item>
            ...
            <div class="mobile-links__item-sub-links" data-collapse-content>
              <ul class="mobile-links mobile-links--level--1">
                ...
                <li class="mobile-links__item" data-collapse-item>
                  <div class="mobile-links__item-title">
                    <a href="order-success.html" class="mobile-links__item-link"
                      >Order Success</a
                    >
                  </div>
                </li>
